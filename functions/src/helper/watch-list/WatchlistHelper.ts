...
export const transformToListProps = async (list: ListModel): Promise<ListProps> => {
...
export const transformToWatchlistTabProps = async (title: string, model: WatchlistModel): Promise<WatchlistTabProps> => {
